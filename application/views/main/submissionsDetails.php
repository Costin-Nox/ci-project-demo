...
<div class="submission-content">
    ...
    <div class="submission-box">
		...
		<?php 
		if (($this->session->userdata('username') == $submissions['username']) || ($level==2)) {?>
			<div class="screenshot-box user-submissions">
				<p>
					<?php 
					if ($this->session->userdata('username') == $submissions['username']) {?>
					<input id="submit_screenshot" type="button"
						value="Upload an Image" style="float: left;" />	<?php } ?>		
