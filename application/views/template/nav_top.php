<div class="float_left">
	...
	<ul id="navigation">
        	...
        	<div class="category_menu_dropdown">
            	...
            	<?php foreach($cat_tree as $key => $category){
            		if (!empty($category["topics"])){ ?>
            			<div id="<?php echo $category["loc_name"]; ?>">
            				<a href="<?php echo base_url(); ?>categories/browse/<?php echo rawurlencode($category["loc_name"]); ?>"><?php echo $category["loc_name"]; ?></a>
                      ...
                      <div class="right_menu">  
                        ...
                        if (!empty($category["topics"])){
                            ...
                            ?>
                            	<a href="<?php echo base_url(); ?>categories/browse/<?php echo rawurlencode($category["loc_name"]); ?>/<?php echo rawurlencode($topics["topic_name"]); ?>"><?php echo $topics["topic_name"] ?></a>
                            <?php 
                            } 
                            echo "</div>";
                        }
                        ...
                        <div class="top_hit_title">
	                        <h3> Top <?php echo $category["loc_name"]; ?> submission:</h3>
	                    </div>
                        <div class="top_hits">
		...
		<li><a class="projects-link" href="<?php ?>">My Reports</a>
		</li>
		<li><a class="link-submit" href="">Submit A Report</a>
		</li>
	</ul>
	<div class="clear"></div>
</div>
<div class="float_right">
	<ul id="navigation_right">
        ...
        <?php } ?>
        <?php if($this->session->userdata('logged_in')) { ?>
		<li><a class="inbox-link" href="javascript:void(0);">Inbox</a><?php } ?>
		</li>
	</ul>
</div>
