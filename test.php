	...
	**/
	...
	class Folder {
		...
		function Folder($path) {
			...
			$this -> exclude_folders 	 = array('_private', '_vti_bin', '_vti_cnf', '_vti_log', '_vti_pvt', '_vti_txt', 'images', 'fonts', 'system', 'uploads', 'third_party', 'logs', 'core', 'errors', 'libraries', 'hooks', 'helpers', 'language', 'config', 'cache', '.svn', 'user_guide', 'sohrab', '_notes');
		}
 
		function count_lines() {
			if( defined('SHOW_DETAILS') ) echo "<strong>/Folder: {$this -> path}...\n</strong><br />";
			$total_lines = 0;
			$this -> get_contents();
